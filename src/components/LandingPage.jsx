...
const LandingPage = () => {
    ...
    const createLinkHandler = () => {
        if (token) {
            navigate("/dashboard");  // ✅ goes to dashboard where they can create links
        } else {
                ...
                <div className=" flex-1">
                    ...
                    <div className="flex items-center gap-3">
                        <motion.button
                            ...
                            className="bg-linear-to-r from-blue-500 to-purple-600 text-white px-6 py-2 rounded-md shadow-md hover:opacity-90 transition cursor-pointer"
                        >
                            Manage Links
                        </motion.button>
                        <motion.button
